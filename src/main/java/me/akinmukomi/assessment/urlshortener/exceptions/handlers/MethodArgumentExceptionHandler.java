package me.akinmukomi.assessment.urlshortener.exceptions.handlers;
...
public class MethodArgumentExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        UrlShortenResponse response = UrlShortenResponse.builder().message("Bad request").errors(errors).build();
